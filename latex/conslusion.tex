...
\item Le choix des méthodes d’empreintes digitales et d’empreintes palmaires à implémenter : été basé sur l’étude faite pendant la phase état de l’art.
...
\begin{itemize}
	...
	\item Étendre « Jupiter » pour qu’elle supporte d’autres représentation d’empreinte digitale (représentation en texture) et d’empreinte palmaire (représentation en minuties) aussi que les images de hautes résolutions.
    ...
    \item Ajouter la possibilité de communications entre les chercheurs sur la plateforme et de créer des groupes de partage (laboratoire, équipe d’un projet, binôme ..etc).
