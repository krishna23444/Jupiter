...
var routerModalities=require('./routes/modalities');
var routerResources=require('./routes/resources');
var routerCategories=require('./routes/categories');
var routerMethods=require('./routes/methods');
//var routerMatlab=require('./routes/matlab');
var routerTests=require('./routes/tests');
var routerKeywords=require('./routes/keywords');
var routerResults=require('./routes/results');
...
app.use('/api', routerModalities);
app.use('/api', routerTests);
app.use('/api', routerKeywords);
app.use('/api', routerResults);
