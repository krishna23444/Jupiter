function [m,V_PCA,Fisher]=BeforeLDA(TrainDatabasePath)

T = CreateDatabase(TrainDatabasePath);
[m V_PCA V_Fisher ProjectedImages_Fisher] = FisherpalmCore(T);
Fisher= struct('V_Fisher',V_Fisher,'ProjectedImages_Fisher',ProjectedImages_Fisher);
...
%---------------------------PALM-------------------------%
function [m_database V_PCA V_Fisher ProjectedImages_Fisher] = FisherpalmCore(T)
% Use Principle Component Analysis (PCA) and Fisher Linear Discriminant (FLD) to determine the most 
% discriminating features between images of palms.
%
...
%%%%%%%%%%%%%%%%%%%%%%%% Snapshot method of Eigenpalm algorithm
